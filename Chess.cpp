...
// Function for finding the shortest path between two positions
void shortestPath(string start, string end) {
    // Array for tracking visited positions
    ...
    while (!q.empty()) {
        ...
        q.pop();
        // get coordinates, distance and path for the current position from currPos
